...
ballpos=[vector(0,-50,0),vector(0,40,0),vector(size,40+balld,0),vector(-size,40+balld,0),vector(2*size,40+2*balld,0),vector(0,40+2*balld,0),vector(-2*size,40+2*balld,0),vector(3*size,40+3*balld,0),vector(size,40+3*balld,0),vector(-size,40+3*balld,0),vector(-3*size,40+3*balld,0),vector(4*size,40+4*balld,0),vector(2*size,40+4*balld,0),vector(0,40+4*balld,0),vector(-2*size,40+4*balld,0),vector(-4*size,40+4*balld,0)]
